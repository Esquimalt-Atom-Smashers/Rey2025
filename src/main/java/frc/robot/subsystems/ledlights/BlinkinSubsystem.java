...
public class BlinkinSubsystem extends SubsystemBase implements CustomSubsystem<BlinkinSubsystem.BlinkinSubsystemStates> {
    ...
    private BlinkinSubsystemStates currentState = BlinkinSubsystemStates.IDLE;

    public enum BlinkinSubsystemStates {
        IDLE,
        secondState,
        thirdstate
    }
    ...
    @Override
    public BlinkinSubsystemStates getState() {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'getState'");
    }

    @Override
    public void setTargetState(BlinkinSubsystemStates state) {
        // TODO Auto-generated method stub
