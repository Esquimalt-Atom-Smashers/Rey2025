...
public class IdleSubsystemsCommand extends ParallelCommandGroup {
    ...
    public IdleSubsystemsCommand(TransferSubsystem transferSubsystem, 
                                 IntakeSubsystem intakeSubsystem, 
                                 ShooterSubsystem shooterSubsystem, 
                                 AimSubsystem aimSubsystem,
                                 CPRotatorSubsystem controlPanelSubsystem) {
        this.addCommands(
            ...
            new InstantCommand(() -> { controlPanelSubsystem.setTargetState(CPRotatorSubsystemStates.IDLE); })
        );
    }
}
